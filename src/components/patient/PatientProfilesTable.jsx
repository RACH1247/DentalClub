...
/*  MAIN COMPONENT                               */
/* ══════════════════════════════════════════════ */
export default function PatientProfilesTable({ patients = [], onRemovePatient }) {
      ...
      {patients.length > 0 && (
        <div className="flex items-center justify-center gap-1.5 mt-4 pt-4 border-t border-slate-100">
          ...
          <p className="text-[10px] text-slate-400 font-medium">
            Patient data persisted in localStorage · Connect a backend API for production storage
          </p>
        </div>
      )}
    </div>
